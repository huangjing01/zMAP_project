...
def pathway_background(filein_df):
    kegg_pathway_file = "/picb/rsgeno/guixiuqi/protein/zmap/enrichr.KEGG_2016.gmt"
    go_bp_pathway_file = "/picb/rsgeno/guixiuqi/protein/zmap/human_GO_Biological_Process_2015.gmt"
    go_cc_pathway_file = "/picb/rsgeno/guixiuqi/protein/zmap/human_GO_Cellular_Component_2015.gmt"
    go_mf_pathway_file = "/picb/rsgeno/guixiuqi/protein/zmap/human_GO_Molecular_Function_2015.gmt" 
...
if __name__=="__main__":
    ...
    parser.add_argument("--bh_pvalue_cutoff",type=float, default=0.05,help="BH-corrected pvalue cutoff used to define hypervariable proteins,default is 0.01")
    ...
    outdir = argv['outdir']
    mkdir(outdir)
    bh_pvalue_cutoff = float(argv['bh_pvalue_cutoff'])
    ...
    sub_protein_clusters,cluster_list = gene_cluster_by_mean_value(mean_hypervariable_df,rearrange_z_trans_df,pvalue_results_df,vmin_value = -6,vmax_value = 6,
                               cluster_number = cluster_num,cutoff = minclustersize,pvalue_cutoff=bh_pvalue_cutoff)
