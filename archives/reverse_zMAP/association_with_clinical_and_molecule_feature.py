...
def drew_bar_continuous(ax,feature,continuous_color_dict,clinical_df):
    ...
    cb1=mpl.colorbar.ColorbarBase(ax,cmap=continuous_color_dict[feature],norm=pc1_norm,ticks=[min_,max_],orientation='horizontal')
...
if __name__=="__main__":
    ...
    print("Identifying differentially expressed proteins between groups.")
    ...
    print("performing pathway enrichment analysis on protein sets coressponging each cluster.")
