...
function(e) {
    ...
    i = {
        ...
        ifSet: function(e, i, t) {
            return t = t || "",
            i && "object" == typeof i && e in i ? i[e] : t
        },
        ...
        dataURI2Blob: function(e) {
            ...
            d ? new Blob([i.hasArrayBufferViewSupport() ? n: a], {
                type: o
        ...
        moveArray: function(e, i, t) {
            ...
            return e.splice(t, 0, e.splice(i, 1)[0]),
            e
        },
        cleanZoomCache: function(e) {
            var i = e.closest(".kv-zoom-cache-theme");
            i.length || (i = e.closest(".kv-zoom-cache")),
            i.remove()
        },
    ...
    t = function(t, a) {
        var n = this;
        n.$element = e(t),
        n._validate() && (n.isPreviewable = i.hasFileAPISupport(), n.isIE9 = i.isIE(9), n.isIE10 = i.isIE(10), n.isPreviewable || n.isIE9 ? (n._init(a), n._listen()) : n.$element.removeClass("file-loading"))
    },
    t.prototype = {
        constructor: t,
        _cleanup: function() {
        ...
        _init: function(t) {
            ...
            o.rtl && (r = o.previewZoomButtonIcons.prev, o.previewZoomButtonIcons.prev = o.previewZoomButtonIcons.next, o.previewZoomButtonIcons.next = r),
            o._cleanup(),
            ...
            o.isClickable = o.browseOnZoneClick && o.showPreview && (o.isUploadable && o.dropZoneEnabled || !i.isEmpty(o.defaultPreviewContent)),
            o.slug = "function" == typeof t.slugCallback ? t.slugCallback: o._slugDefault,
            o.mainTemplate = o.showCaption ? o._getLayoutTemplate("main1") : o._getLayoutTemplate("main2"),
            o.captionTemplate = o._getLayoutTemplate("caption"),
            o.previewGenericTemplate = o._getPreviewTemplate("generic"),
            o.resizeImage && (o.maxImageWidth || o.maxImageHeight) && (o.imageCanvas = document.createElement("canvas"), o.imageCanvasContext = o.imageCanvas.getContext("2d")),
            i.isEmpty(l.attr("id")) && l.attr("id", i.uniqId()),
            o.namespace = ".fileinput_" + l.attr("id").replace(/-/g, "_"),
            void 0 === o.$container ? o.$container = o._createContainer() : o._refreshContainer(),
            a = o.$container,
            o.$dropZone = a.find(".file-drop-zone"),
            o.$progress = a.find(".kv-upload-progress"),
            o.$btnUpload = a.find(".fileinput-upload"),
            o.$captionContainer = i.getElement(t, "elCaptionContainer", a.find(".file-caption")),
            o.$caption = i.getElement(t, "elCaptionText", a.find(".file-caption-name")),
            o.$previewContainer = i.getElement(t, "elPreviewContainer", a.find(".file-preview")),
            o.$preview = i.getElement(t, "elPreviewImage", a.find(".file-preview-thumbnails")),
            o.$previewStatus = i.getElement(t, "elPreviewStatus", a.find(".file-preview-status")),
            o.$errorContainer = i.getElement(t, "elErrorContainer", o.$previewContainer.find(".kv-fileinput-error")),
        ...
        _initTemplateDefaults: function() {
            var t, a, n, r, o, l, s, d, c, u, p, f, m, v, h, g, w, _, b, C, y, T, E, x, F, S, I, k, P, z, A, $, D, U, B, j, L = this;
            ...
            r = '<i class="fa kv-caption-icon"></i>',
            ...
            u = '<div id="' + i.MODAL_ID + '" class="file-zoom-dialog modal fade" tabindex="-1" aria-labelledby="' + i.MODAL_ID + 'Label"></div>',
            ...
            g = '<button type="button" class="kv-file-remove {removeClass}" title="{removeTitle}" {dataUrl}{dataKey}>{removeIcon}</button>\n',
            ...
            C = '<div class="file-upload-indicator" title="{indicatorTitle}">{indicator}</div>',
            y = '<div class="file-preview-frame {frameClass}" id="{previewId}" data-fileindex="{fileindex}" data-template="{template}"',
            ...
            L.defaults = {
                ...
                fileActionSettings: {
                    ...
                    zoomIcon: '<i class="fa fa-upload text-info"></i>',
            ...
            e.each(L.defaults,
            function(i, t) {
                return "allowedPreviewTypes" === i ? void(void 0 === L.allowedPreviewTypes && (L.allowedPreviewTypes = t)) : void(L[i] = e.extend(!0, {},
                t, L[i]))
            }),
        ...
        _initPreviewTemplates: function() {
            ...
            o = r.tagAfter;
            e.each(n.previewContentTemplates,
            function(e, n) {
            ...
            t.previewCache = {
                ...
                get: function(a, n) {
                    ...
                    w = function(e, a, n, r, o, l, s, d, c) {
                        return d = " file-preview-initial " + i.SORT_CSS + (d ? " " + d: ""),
                ...
                add: function(e, a, n, r) {
                    ...
                    return i.isArray(e) || (e = e.split(t.initialPreviewDelimiter)),
                    r ? (o = l.content.push(e) - 1, l.config[o] = a, l.tags[o] = n) : (o = e.length - 1, l.content = e, l.config = a, l.tags = n),
                ...
                unset: function(e) {
                    ...
                    if (i) {
                        if (1 === i) return t.previewCache.data.content = [],
                ...
                footer: function(e, a, n) {
                    ...
                    g = c === !1 && a;
                    return o = t._renderFileActions(!1, m, v, h, g, c, u, !0),
        ...
        _addError: function(e) {
            var i = this,
            t = i.$errorContainer;
            e && t.length && (t.html(i.errorCloseButton + e), i._handler(t.find(".kv-error-close"), "click",
            function() {
                t.fadeOut("slow")
            }))
        },
        ...
        _showUploadError: function(e, t, a) {
            ...
            return 0 === r.find("ul").length ? n._addError("<ul>" + l + "</ul>") : r.find("ul").append(l),
            r.fadeIn(800),
            n._raise(o, [t, e]),
        ...
        _parseError: function(i, t, a, n) {
            ...
            return r.cancelling && r.msgUploadAborted && (o = r.msgUploadAborted),
            r.showAjaxErrorDetails && s ? (s = e.trim(s.replace(/\n\s*\n/g, "\n")), s = s.length > 0 ? "<pre>" + s + "</pre>": "", o += l + s) : o += l,
        ...
        _getPreviewIcon: function(i) {
            var t, a = this,
            n = null;
            return i && i.indexOf(".") > -1 && (t = i.split(".").pop(), a.previewFileIconSettings && (n = a.previewFileIconSettings[t] || a.previewFileIconSettings[t.toLowerCase()] || null), a.previewFileExtSettings && e.each(a.previewFileExtSettings,
            function(e, i) {
        ...
        _initClickable: function() {
            var t, a = this;
            a.isClickable && (t = a.isUploadable ? a.$dropZone: a.$preview.find(".file-default-preview"), i.addCss(t, "clickable"), t.attr("tabindex", -1), a._handler(t, "click",
            function(i) {
                var n = e(i.target);
        ...
        _zoneDragEnter: function(t) {
            ...
            return a._zoneDragDropInit(t),
            a.isDisabled || !n ? (t.originalEvent.dataTransfer.effectAllowed = "none", void(t.originalEvent.dataTransfer.dropEffect = "none")) : void i.addCss(a.$dropZone, "file-highlighted")
        },
        ...
        _zoneDrop: function(e) {
            var t = this;
            e.preventDefault(),
            t.isDisabled || i.isEmpty(e.originalEvent.dataTransfer.files) || (t._change(e, "dragdrop"), t.$dropZone.removeClass("file-highlighted"))
        },
        ...
        _clearPreview: function() {
            ...
            n.each(function() {
                var t = e(this);
                t.remove(),
                i.cleanZoomCache(a.find("#zoom-" + t.attr("id")))
            }),
        ...
        _initSortable: function() {
            ...
            window.KvSortable && 0 !== n.find(r).length && (t = {
                ...
                onSort: function(t) {
                    ...
                    a.initialPreviewConfig = i.moveArray(a.initialPreviewConfig, o, l),
                    a.previewCache.init();
        ...
        _getZoomButton: function(e) {
            ...
            '<button type="button" class="' + a + " btn-" + e + '"' + r + ">" + t + "</button>"
        },
        ...
        _listenModalEvent: function(e) {
            ...
            function(r) {
                ...
                "shown" === e && (l.removeClass("active").attr("aria-pressed", "false"), o.removeClass("active").attr("aria-pressed", "false"), a.hasClass("file-zoom-fullscreen") && (t._maximizeZoomDialog(), i.checkFullScreen() ? o.addClass("active").attr("aria-pressed", "true") : l.addClass("active").attr("aria-pressed", "true")))
            })
        },
        _initZoom: function() {
            var t, a = this,
            ...
            r = "#" + i.MODAL_ID;
            a.showPreview && (a.$modal = e(r), a.$modal && a.$modal.length || (t = e(document.createElement("div")).html(n).insertAfter(a.$container), a.$modal = e(r).insertBefore(t), t.remove()), i.initModal(a.$modal), a.$modal.html(a._getModalContent()), e.each(i.MODAL_EVENTS,
            function(e, i) {
        ...
        _resizeZoomDialog: function(e) {
            ...
            if (a.hasClass("file-zoom-fullscreen")) i.toggleFullScreen(!1),
            e ? n.hasClass("active") || (a.removeClass("file-zoom-fullscreen"), t._resizeZoomDialog(!0), r.hasClass("active") && r.removeClass("active").attr("aria-pressed", "false")) : n.hasClass("active") ? n.removeClass("active").attr("aria-pressed", "false") : (a.removeClass("file-zoom-fullscreen"), t.$modal.find(".kv-zoom-body").css("height", t.zoomModalHeight));
            else {
        ...
        _setZoomContent: function(t, a) {
            ...
            c && (d = s.find(".kv-preview-data"), i.addCss(d, "file-zoom-detail"), e.each(c,
            function(e, i) {
                d.css(e, i),
            ...
            function() {
                ...
                n = function(e) {
                    ...
                    a = m.zoomModalHeight;
                    h.hasClass("file-zoom-fullscreen") && (a = t.outerHeight(!0), e || (a -= i.outerHeight(!0))),
                    t.css("height", e ? a + e: a)
                };
                i.is(":visible") ? (e = i.outerHeight(!0), i.slideUp("slow",
                function() {
                    a.find(".btn").appendTo(t),
                    n(e)
                })) : (t.find(".btn").appendTo(a), i.slideDown("slow",
                function() {
                    n()
                })),
                h.focus()
            }),
            m._handler(h, "keydown",
            function(e) {
        ...
        _clearFileInput: function() {
            ...
            i.isEmpty(o.val()) || (r.isIE9 || r.isIE10 ? (t = o.closest("form"), a = e(document.createElement("form")), n = e(document.createElement("div")), o.before(n), t.length ? t.after(a) : n.after(a), a.append(o).trigger("reset"), n.before(o).remove(), a.remove()) : o.val(""))
        },
        ...
        _resetPreview: function() {
            var e, i, t = this;
            t.previewCache.count() ? (e = t.previewCache.out(), t.$preview.html(e.content), t._setInitThumbAttr(), i = t.initialCaption ? t.initialCaption: e.caption, t._setCaption(i)) : (t._clearPreview(), t._initCaption()),
        ...
        _uploadSingle: function(t, a, n) {
            var r, o, l, s, d, c, u, p, f, m, v = this,
            ...
            v.formdata = g,
            v.showPreview && (o = e("#" + w + ":not(.file-preview-initial)"), s = o.find(".kv-file-upload"), d = o.find(".kv-file-remove"), b.removeClass("hide")),
            0 === h || !_ || s && s.hasClass("disabled") || v._abort(C) || (m = function(e, i) {
                ...
                v.fileBatchCompleted && (o && o.content && (r = o.content.length), setTimeout(function() {
                    if (v.showPreview) {
                        if (v.previewCache.set(n.content, n.config, n.tags, n.append), r) {
                            for (t = 0; t < n.content.length; t++) a = t + r,
                        ...
                        } else v.initialPreview = n.content,
                    ...
                    v.uploadAsync && e.length && (i.addCss(e, i.SORT_CSS), v._initSortable()),
            ...
            c = function(a) {
                ...
                v.showPreview && (o.hasClass("file-preview-success") || (v._setThumbStatus(o, "Loading"), i.addCss(o, "file-uploading")), s.attr("disabled", !0), d.attr("disabled", !0)),
                n || v.lock(),
                v._raise("filepreupload", [r, w, t]),
                e.extend(!0, C, r),
                v._abort(C) && (a.abort(), v._setProgressCancelled())
            },
            u = function(a, l, d) {
                var c = v.showPreview && o.attr("id") ? o.attr("id") : w;
                r = v._getOutData(d, a),
                e.extend(!0, C, r),
                setTimeout(function() {
                    i.isEmpty(a) || i.isEmpty(a.error) ? (v.showPreview && (v._setThumbStatus(o, "Success"), s.hide(), v._initUploadSuccess(a, o, n), v._setProgress(101, b)), v._raise("fileuploaded", [r, c, t]), n ? m(t, c) : v.updateStack(t, void 0)) : (v._showUploadError(a.error, C), v._setPreviewError(o, t), n && m(t, c))
                },
                100)
            },
            p = function() {
                setTimeout(function() {
                    v.showPreview && (s.removeAttr("disabled"), d.removeAttr("disabled"), o.removeClass("file-uploading")),
                    n ? l() : (v.unlock(!1), v._clearFileInput()),
            ...
            f = function(i, r, l) {
                ...
                d = v._parseError(s, i, l, n ? a[t].name: null);
                setTimeout(function() {
                    n && m(t, w),
                    v.uploadStatus[w] = 100,
                    v._setPreviewError(o, t),
                    e.extend(!0, C, v._getOutData(i)),
                    v._setProgress(101, b, v.msgAjaxProgressError.replace("{operation}", s)),
                    v._showUploadError(d, C)
                },
                100)
            },
            g.append(v.uploadFileAttr, a[t], v.filenames[t]), g.append("file_id", t), v._ajaxSubmit(c, u, p, f, w, t))
        },
        _uploadBatch: function() {
            ...
            a = function(t, a, n) {
                ...
                i.isEmpty(t) || i.isEmpty(t.error) ? (l._raise("filebatchuploadsuccess", [r]), o(), l.showPreview ? (s.each(function() {
                    ...
                    t.removeAttr("disabled"),
                    0 === c.length ? void l._setPreviewError(i) : ( - 1 !== e.inArray(d, c) ? l._setPreviewError(i) : (i.find(".kv-file-upload").hide(), l._setThumbStatus(i, "Success"), l.updateStack(d, void 0)), void d++)
        ...
        _initFileActions: function() {
            ...
            t.showPreview && (t._initZoomButton(), t.getFrames(" .kv-file-remove").each(function() {
                ...
                t._handler(s, "click",
                function() {
                    return l = t._raise("filepreremove", [c, u]),
                    l !== !1 && t._validateMinCount() ? (n = d.hasClass("file-preview-error"), i.cleanMemory(d), void d.fadeOut("slow",
                    function() {
                        i.cleanZoomCache(a.find("#zoom-" + c)),
                        t.updateStack(u, void 0),
                        t._clearObjects(d),
                        d.remove(),
                        c && n && t.$errorContainer.find('li[data-file-id="' + c + '"]').fadeOut("fast",
                        function() {
                            e(this).remove(),
                        ...
                        0 !== p || 0 !== s || f ? (r = s + p, o = r > 1 ? t._getMsgSelected(r) : l[0] ? t._getFileNames()[0] : "", t._setCaption(o)) : t.reset(),
        ...
        _initPreviewActions: function() {
            ...
            a.find(r).each(function() {
                ...
                if (!i.isEmpty(l) && void 0 !== s) {
                    ...
                    u = i.isEmpty(m.config) && i.isEmpty(m.config[v]) ? null: m.config[v],
                    ...
                    d = e.extend(!0, {},
                    {
                        ...
                        beforeSend: function(e) {
                            ...
                            t.ajaxAborted ? e.abort() : (i.addCss(f, "file-uploading"), i.addCss(r, "disabled"))
                        },
                        success: function(e, n, l) {
                            var d, u;
                            return i.isEmpty(e) || i.isEmpty(e.error) ? (v = parseInt(f.attr("data-fileindex").replace("init_", "")), t.previewCache.unset(v), d = t.previewCache.count(), u = d > 0 ? t._getMsgSelected(d) : "", t._deleteFileIndex(f), t._setCaption(u), t._raise("filedeleted", [s, l, p]), f.removeClass("file-uploading").addClass("file-deleted"), void f.fadeOut("slow",
                            function() {
                                i.cleanZoomCache(a.find("#zoom-" + f.attr("id"))),
                                t._clearObjects(f),
                                f.remove(),
                                o(),
                                d || 0 !== t.getFileStack().length || (t._setCaption(""), t.reset())
        ...
        _generatePreviewTemplate: function(t, a, n, r, o, l, s, d, c, u, p) {
            ...
            x = function(a, l, s, c) {
                ...
                g = (d || "") + " " + c;
                return m.frameClass && (g = m.frameClass + " " + g),
                s && (g = g.replace(" " + i.SORT_CSS, "")),
                h = m._parseFilePreviewIcon(h, n),
                "text" === a && (l = i.htmlEncode(l)),
                "object" !== t || r || e.each(m.defaults.fileTypeSettings,
                function(e, i) {
            ...
            return u = u || o.slice(o.lastIndexOf("-") + 1),
            m.fileActionSettings.showZoom && (h = x(E ? "other": t, a, !0, "kv-zoom-thumb")),
        ...
        _previewFile: function(e, t, a, n, r) {
            if (this.showPreview) {
                ...
                if ("html" === s && l.purifyHtml && window.DOMPurify && (g = window.DOMPurify.sanitize(g)), m || w) {
                    ...
                    f.append("\n" + o);
                    var _ = f.find("#" + n + " img");
                    _.length && l.autoOrientImage ? i.validateOrientation(t,
                    function(e) {
                        if (e) {
                            var a = f.find("#zoom-" + n + " img"),
                            r = "rotate-" + e;
                            e > 4 && (r += _.width() > _.height() ? " is-portrait-gt4": " is-landscape-gt4"),
                            i.addCss(_, r),
                            i.addCss(a, r),
                            l._raise("fileimageoriented", {
                                $img: _,
                                file: t
                            })
                        }
        ...
        _readFiles: function(t) {
            ...
            y = function(i, r, o, l) {
                ...
                return n._previewDefault(r, o, !0),
                n.isUploadable && (n.addToStack(void 0), setTimeout(function() {
                    a(l + 1)
                },
                100)),
                n._initFileActions(),
            ...
            a = function(e) {
                if (i.isEmpty(r.attr("multiple")) && (f = 1), e >= f) return n.isUploadable && n.filestack.length > 0 ? n._raise("filebatchselected", [n.getFileStack()]) : n._raise("filebatchselected", [t]),
                s.removeClass("file-thumb-loading"),
                void d.html("");
                ...
                R = 0,
                Z = "";
                if (g > 0) for (F = 0; g > F; F++) P = h[F],
                z = n.msgFileTypes[P] || P,
                Z += 0 === F ? z: ", " + z;
                if (B === !1) return void a(e + 1);
                if (0 === B.length) return S = n.msgInvalidFileName.replace("{name}", i.htmlEncode(U.name)),
                ...
                if (!i.isEmpty(h) && i.isArray(h)) {
                    for (F = 0; F < h.length; F += 1) I = h[F],
                    A = m[I],
                    R += A && "function" == typeof A && A(U.type, U.name) ? 1 : 0;
        ...
        _setProgress: function(e, t, a) {
            ...
            t = t || r.$progress,
            i.isEmpty(d) || (n = l && o > l && 100 >= e ? d.setTokens({
                percent: l,
        ...
        _setFileDropZoneTitle: function() {
            ...
            n = t.dropZoneTitle;
            t.isClickable && (e = i.isEmpty(t.$element.attr("multiple")) ? t.fileSingle: t.filePlural, n += t.dropZoneClickTitle.replace("{files}", e)),
            a.find("." + t.dropZoneTitleClass).remove(),
            t.isUploadable && t.showPreview && 0 !== a.length && !(t.getFileStack().length > 0) && t.dropZoneEnabled && (0 === a.find(i.FRAMES).length && i.isEmpty(t.defaultPreviewContent) && a.prepend('<div class="' + t.dropZoneTitleClass + '">' + n + "</div>"), t.$container.removeClass("file-input-new"), i.addCss(t.$container, "file-input-ajax-new"))
        },
        ...
        _getFileCount: function(e) {
            var i = this,
            t = 0;
            return i.validateInitialCount && !i.overwriteInitial && (t = i.previewCache.count(), e += t),
            e
        },
        ...
        _checkDimensions: function(e, t, a, n, r, o, l) {
            var s, d, c, u, p = this,
            f = "Small" === t ? "min": "max",
            m = p[f + "Image" + o]; ! i.isEmpty(m) && a.length && (c = a[0], d = "Width" === o ? c.naturalWidth || c.width: c.naturalHeight || c.height, u = "Small" === t ? d >= m: m >= d, u || (s = p["msgImage" + o + t].setTokens({
                name: r,
                size: m
        ...
        _validateImage: function(i, t, a, n, r) {
            ...
            function() {
                ...
                c.resizeImage || (c._checkDimensions(f, "Large", m, p, t, "Width", o), c._checkDimensions(f, "Large", m, p, t, "Height", o)),
        ...
        _validateAllImages: function() {
            ...
            if (r === a.totalImagesCount && (a._raise("fileimagesloaded"), a.resizeImage)) for (e = 0; e < a.loadedImages.length; e++) i = a.loadedImages[e],
            i.validated || (t = i.siz, t && t > 1e3 * o && a._getResizedImage(i, n, r), a.loadedImages[e].validated = !0)
        },
        _getResizedImage: function(t, a, n) {
            ...
            o = m > g,
            l = v > w,
            h = "width" === p.resizePreference ? o ? g / m: l ? w / v: 1 : l ? w / v: o ? g / m: 1,
            p._resetCanvas(),
            m *= h,
            v *= h,
            b.width = m,
            ...
            try {
                ...
                r instanceof Blob || d(p.msgImageResizeError, {
                    id: T,
                    index: E
                },
                "fileimageresizeerror")
        ...
        _setCaption: function(t, a) {
            ...
            if (s.$caption.length) {
                ...
                o = d.length,
                l = o ? 1 === o && d[0] ? s._getFileNames()[0] : s._getMsgSelected(o) : s._getMsgSelected(s.msgNo),
                r = '<span class="' + s.msgValidationErrorClass + '">' + s.msgValidationErrorIcon + (i.isEmpty(t) ? l: t) + "</span>";
                else {
        ...
        _renderFileFooter: function(e, t, a, n) {
            ...
            return t = o._getSize(t),
            r = o.isUploadable ? p.setTokens({
        ...
        _browse: function(e) {
            var i = this;
            i._raise("filebrowse"),
            e && e.isDefaultPrevented() || (i.isError && !i.isUploadable && i.clear(), i.$captionContainer.focus())
        },
        ...
        _change: function(t) {
            ...
            if (a.reader = null, a._resetUpload(), a._hideFileIcon(), a.isUploadable && a.$container.find(".file-drop-zone ." + a.dropZoneTitleClass).remove(), c ? e.each(p,
            function(e, i) {
            ...
            }) : d = p), i.isEmpty(d) || 0 === d.length) return u || a.clear(),
        ...
        _abort: function(i) {
            var t, a = this;
            return a.ajaxAborted && "object" == typeof a.ajaxAborted && void 0 !== a.ajaxAborted.message ? (t = e.extend(!0, {},
            a._getOutData(), i), t.abortData = a.ajaxAborted.data || {},
            t.abortMessage = a.ajaxAborted.message, a._setProgress(101, a.$progress, a.msgCancelled), a._showUploadError(a.ajaxAborted.message, t, "filecustomerror"), a.cancel(), !0) : !1
        },
        ...
        _isFileSelectionValid: function(e) {
            var i = this;
            return e = e || 0,
            i.required && !i.getFilesCount() ? (i.$errorContainer.html(""), i._showUploadError(i.msgFileRequired), !1) : i.minFileCount > 0 && i._getFileCount(e) < i.minFileCount ? (i._noFilesError({}), !1) : !0
        },
        clearStack: function() {
            var e = this;
            return e.filestack = [],
        ...
        cancel: function() {
            ...
            a = t.ajaxRequests,
            n = a.length;
            if (n > 0) for (i = 0; n > i; i += 1) t.cancelling = !0,
            a[i].abort();
            return t._setProgressCancelled(),
            t._getThumbs().each(function() {
                var i = e(this),
        ...
        clear: function() {
            ...
            }), a.isUploadable && (a.previewCache.data = {}), a.$preview.html(""), t = !a.overwriteInitial && a.initialCaption.length > 0 ? a.initialCaption: "", a.$caption.html(t), a.$caption.attr("title", ""), i.addCss(a.$container, "file-input-new"), a._validateDefaultPreview()),
            0 === a.$container.find(i.FRAMES).length && (a._initCaption() || a.$captionContainer.find(".kv-caption-icon").hide()),
            a._hideFileIcon(),
        ...
        reset: function() {
            ...
            (e.getFrames().length || e.isUploadable && e.dropZoneEnabled) && e.$container.removeClass("file-input-new"),
        ...
        upload: function() {
            ...
            if (r.isUploadable && !r.isDisabled && r._isFileSelectionValid(o)) {
                ...
                if (r.$progress.removeClass("hide"), r.uploadCount = 0, r.uploadStatus = {},
                r.uploadLog = [], r.lock(), r._setProgress(2), 0 === o && l) return void r._uploadExtraOnly();
                if (n = r.filestack.length, r.hasInitData = !1, !r.uploadAsync) return r._uploadBatch(),
                r.$element;
                ...
                r.uploadAsyncCount = r.getFileStack().length, t = 0; n > t; t++) r.uploadCache.content[t] = null,
    ...
    e.fn.fileinput = function(a) {
        if (i.hasFileAPISupport() || i.isIE(9)) {
            ...
            switch (n.shift(), this.each(function() {
                ...
                s || (c && (p = e.fn.fileinputThemes[c] || {}), "en" === f || i.isEmpty(e.fn.fileinputLocales[f]) || (u = e.fn.fileinputLocales[f] || {}), o = e.extend(!0, {},
                e.fn.fileinput.defaults, p, e.fn.fileinputLocales.en, u, d, l.data()), s = new t(this, o), l.data("fileinput", s)),
    ...
    e.fn.fileinput.defaults = {
        ...
        cancelIcon: '<i class="fa fa-stop"></i>',
