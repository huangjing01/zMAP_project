...
def window_vaplot(sorted_table,num_of_sample,window_size = 400,sliding_size = 100,output_dir="",top_gene_used_to_fit_linear_model = 0.3,batch=""):
  ...
  #  linear_regression = result_dir + "/linear_model"
    ...
    mean_a_scope_df.to_csv(output_dir + "/"+"%s_mean_A_estimated_variance.txt"%(batch),sep ="\t")
